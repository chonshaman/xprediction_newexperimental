...
var require_dist = __commonJS({
  "node_modules/@rive-app/react-canvas/dist/index.js"(exports) {
    ...
    function useResizeCanvas(e) {
      var t = e.riveLoaded, n = void 0 !== t && t, a = e.canvasElem, r = e.containerRef, u = e.options, i = e.onCanvasHasResized, o = e.artboardBounds, s = getOptions(void 0 === u ? {} : u), c = React.useState({ height: 0, width: 0 }), l = c[0], f = l.height, d = l.width, v = c[1], p = React.useState({ height: 0, width: 0 }), R = p[0], b = R.height, h = R.width, g = p[1], w = React.useState(true), y = w[0], m = w[1], I = s.fitCanvasToArtboardHeight, V = s.shouldResizeCanvasToContainer, C = s.useDevicePixelRatio, O = s.customDevicePixelRatio, M = useSize(r, V), x = useDevicePixelRatio(O), E = null != o ? o : {}, P = E.maxX, _ = E.maxY, k = React.useCallback(function() {
      ...
      }, [a, r, M, x, k, y, m, b, h, f, d, i, V, I, C, n]), React.useEffect(function() {
        g({ width: 0, height: 0 });
      }, [a]);
    }
    ...
    function RiveComponent(e) {
      ...
      return React__default.default.createElement("div", _extends$1({ ref: t, className: r }, !r && { style: s }), React__default.default.createElement("canvas", _extends$1({ ref: n, style: { verticalAlign: "top", width: 0, height: 0 } }, o), i));
    }
    function useRive(e, t) {
      ...
      var p = React.useCallback(function(e2) {
      ...
      var R = React.useCallback(function(e2) {
        u.current = e2;
      ...
      }, [h, g, s, a, f.shouldUseIntersectionObserver]), React.useEffect(function() {
        return function() {
          s && (s.cleanup(), c(null));
        };
      }, [s, a]), React.useEffect(function() {
        return function() {
      ...
      var y = React.useCallback(function(e2) {
        return React__default.default.createElement(RiveComponent, _extends$1({ setContainerRef: R, setCanvasRef: p }, e2));
      }, [p, R]);
    ...
    var Rive = function(e) {
      ...
      return React__default.default.createElement(d, f, l);
    };
    ...
    function useViewModelInstanceProperty(e, t, n) {
      ...
      var b = React.useCallback(function(e2) {
